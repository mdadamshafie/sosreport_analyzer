"""
SOSreport Analyzer V4 - Streamlit Web Application
...
st.set_page_config(
    page_title="SOSreport Analyzer V4",
    page_icon="ðŸ“Š",
    layout="wide",
...
def detect_installed_packages(sosreport_path: str) -> dict:
    ...
    rpm_files = [
        os.path.join(sosreport_path, "sos_commands", "rpm", "sh_-c_rpm_--nodigest_-qa_--qf_-59_NVRA_INSTALLTIME_date_sort_-V"),
...
def main():
    st.markdown('<h1 class="main-header">ðŸ“Š SOSreport Analyzer V4</h1>', unsafe_allow_html=True)
    st.markdown("---")
...
'''
    ...
    st.markdown(
        ...
        "SOSreport Analyzer V4 | Powered by Streamlit, InfluxDB, Loki & Grafana | System Info + Anomaly Detection + Critical Events"
        "</div>",
        unsafe_allow_html=True
    )
