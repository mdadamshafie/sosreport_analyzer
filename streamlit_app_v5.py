"""
SOSreport Analyzer V5 - Streamlit Web Application
...
- Subscription/Patch Compliance Check (NEW in V5)
- Copy-Paste Summary for tickets (NEW in V5)
- Timestamp Correlation View (NEW in V5)
"""
...
st.set_page_config(
    page_title="SOSreport Analyzer V5",
    page_icon="ðŸ“Š",
    layout="wide",
...
def generate_copy_paste_summary(hostname: str, system_info: dict, sar_anomalies: dict,
                                ...
                                patch_compliance: dict = None) -> str:
    ...
    lines.append("")
    lines.append("=" * 70)
    lines.append(f"  Generated by SOSreport Analyzer V5")
    lines.append("=" * 70)
...
def main():
    st.markdown('<h1 class="main-header">ðŸ“Š SOSreport Analyzer V5</h1>', unsafe_allow_html=True)
    st.markdown("---")
...
'''
    ...
    st.markdown(
        ...
        "SOSreport Analyzer V5 | Powered by Streamlit, InfluxDB, Loki & Grafana | System Info + Anomaly Detection + Critical Events + Patch Compliance"
        "</div>",
        unsafe_allow_html=True
    )
